...
function statusIcon(status: OrderStatus) {
  switch (status) {
    ...
    case 'SHIPPED':
      return <Truck className="h-5 w-5 text-[var(--color-accent)]" />;
    case 'CANCELLED':
      return <XCircle className="h-5 w-5 text-[var(--color-error)]" />;
    default:
      return <Package className="h-5 w-5 text-[var(--color-muted)]" />;
  }
}
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-10 sm:py-14">
      ...
      <Reveal>
        <form
          onSubmit={onTrack}
          className="mt-8 grid gap-4 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] p-5 sm:grid-cols-2 sm:p-6"
        >
          <Input
            id="order-number"
            label="Order Number"
      ...
      {error && (
        <div className="mt-4 rounded-md bg-red-50 p-3 text-sm text-[var(--color-error)]">
          {error}
        </div>
      )}
        ...
        <Reveal>
          <section className="mt-8 rounded-lg border border-[var(--color-border)] bg-[var(--color-surface)] p-6">
            ...
            <div className="mt-6 border-t border-[var(--color-border)] pt-4 text-sm">
              ...
              <div className="mt-2 flex justify-between font-semibold text-[var(--color-primary)]">
                <span>Total</span>
